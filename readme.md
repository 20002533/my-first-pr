...
4. Note the name of your repository `URL` here: **<URL>**
   ...
   https://github.com/20002533/my-first-pr
...
This is probably because we are working from our local copy at the moment.
---
...
It appears as though the branch does not exist on the GitHub side yet, probably because the git switch -c command outlined above was performed on the local copy as opposed to the remote one.
